...
app.get("/", cors(), async (request, response) => response.send("hello world"));

app.get("/players/", cors(), async (request, response) => {
...
app.get("/players/:playerId/", cors(), async (request, response) => {
...
app.put("/players/:playerId/", cors(), async (request, response) => {
  const { playerId } = request.params;
...
app.get("/matches/:matchId/", cors(), async (request, response) => {
...
app.get("/players/:playerId/matches/", cors(), async (request, response) => {
  const { playerId } = request.params;
